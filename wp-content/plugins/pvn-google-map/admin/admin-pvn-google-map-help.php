...
<div class="wrap">
    ...
    <h1><?php _e('Help', 'pvn-google-map');
        echo ' ' . $mapmarker_info[ 'plugin_name' ] ?></h1>
    <p></p>
    <div class="wrap-help-mmm">
        <h2><?php _e('To use the plugin simply insert your shortcode into post, page or widget.', 'pvn-google-map'); ?></h2>
    ...
    <div class="wrap-help-mmm">
        <h2><?php _e('Example of CSV file separated by ";".', 'pvn-google-map'); ?></h2>
