<div class="wrap">
    ...
    if(isset($_POST[ 'securite_nonce_option' ])){
        ...
        if(wp_verify_nonce($_POST[ 'securite_nonce_option' ], 'securite_nonce_option')){
            ...
            mapmarker_message_alert(__('Your options have been saved.', 'pvn-google-map'), 'updated');
                ...
                <h4 class="panel-title">
                    <a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseOne"
                       aria-expanded="false" aria-controls="collapseOne" class="action-accordeon collapsed">
                        <i class="fa fa-cogs" aria-hidden="true"></i> <?php _e('Map option', 'pvn-google-map'); ?> <i
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <table class="form-table">
                                    <tr>
                                        <th scope="row">
                                            <label for="map_name"><?php _e('Map name', 'pvn-google-map'); ?></label>
                                    ...
                                    <tr>
                                        <th scope="row">
                                            <label for="height_map"><?php _e('Height', 'pvn-google-map'); ?></label>
                                    ...
                                    <tr>
                                        <th scope="row">
                                            <label for="width_map"><?php _e('Width', 'pvn-google-map'); ?></label>
                                    ...
                                    <tr>
                                        <th scope="row">
                                            <label for="zoom"><?php _e('Initial zoom', 'pvn-google-map'); ?></label>
                                    ...
                                    <tr>
                                        <th scope="row">
                                            <label
                                                for="latitude_initial"><?php _e('Initial latitude', 'pvn-google-map'); ?></label>
                                    ...
                                    <tr>
                                        <th scope="row">
                                            <label
                                                for="longitude_initial"><?php _e('Initial longitude', 'pvn-google-map'); ?></label>
                                    ...
                                    <tr>
                                        <th scope="row">
                                            <label for="maptype"><?php _e('Map type', 'pvn-google-map'); ?></label>
                            ...
                            <div class="col-md-6">
                                <table class="form-table">
                                    <tr>
                                        <th scope="row">
                                            <label for="lightbox"><?php _e('Lightbox', 'pvn-google-map'); ?></label>
                                    ...
                                    <tr>
                                        <th scope="row">
                                            <label
                                                for="scrollwheel"><?php _e('Scrollwheel zoom', 'pvn-google-map'); ?></label>
                                    ...
                                    <tr>
                                        <th scope="row">
                                            <label
                                                for="streetview"><?php _e('Streetview', 'pvn-google-map'); ?></label>
                                    ...
                                    <tr>
                                        <th scope="row">
                                            <label
                                                for="fiels_to_display"><?php _e('Fields to display in tooltip', 'pvn-google-map'); ?></label>
                                            <span class="help_tooltip" id="help_map_fiels_to_display"><i
                                                    class="fa fa-question-circle" aria-hidden="true"></i></span>
                                        </th>
                                        <td>
                                            <input id="fiels_to_display" type="checkbox" name="fiels_to_display[]"
                                                   value="image" <?php mapmarker_check_checked($data[ 0 ][ 'fiels_to_display' ], 'image') ?>><?php _e('Image', 'pvn-google-map'); ?>
                                            <br>
                                            <input id="fiels_to_display" type="checkbox" name="fiels_to_display[]"
                                                   value="titre" <?php mapmarker_check_checked($data[ 0 ][ 'fiels_to_display' ], 'titre') ?>><?php _e('Title', 'pvn-google-map'); ?>
                                            <br>
                                            <input id="fiels_to_display" type="checkbox" name="fiels_to_display[]"
                                                   value="description" <?php mapmarker_check_checked($data[ 0 ][ 'fiels_to_display' ], 'description') ?>><?php _e('Description', 'pvn-google-map'); ?>
                                            <br>
                                            <input id="fiels_to_display" type="checkbox" name="fiels_to_display[]"
                                                   value="adresse" <?php mapmarker_check_checked($data[ 0 ][ 'fiels_to_display' ], 'adresse') ?>><?php _e('Address', 'pvn-google-map'); ?>
                                            <br>
                                            <input id="fiels_to_display" type="checkbox" name="fiels_to_display[]"
                                                   value="telephone" <?php mapmarker_check_checked($data[ 0 ][ 'fiels_to_display' ], 'telephone') ?>><?php _e('Phone', 'pvn-google-map'); ?>
                                            <br>
                                            <input id="fiels_to_display" type="checkbox" name="fiels_to_display[]"
                                                   value="weblink" <?php mapmarker_check_checked($data[ 0 ][ 'fiels_to_display' ], 'weblink') ?>><?php _e('Web link', 'pvn-google-map'); ?>
                                        </td>
                                    </tr>
                                    <tr>
                                        <th scope="row">
                                            <label
                                                for="default_desc_img"><?php _e('Default image tooltip when a new marker is created', 'pvn-google-map'); ?></label>
                                    ...
                                    <tr>
                                        <th scope="row">
                                            <label
                                                for="default_marker_img"><?php _e('Default marker icon when a new marker is created', 'pvn-google-map'); ?></label>
                        ...
                        <p class="submit">
                            <button type="submit" name="save_option" id="save_option" class="button button-primary">
                                <i class="fa fa-floppy-o"
                                   aria-hidden="true"></i> <?php _e('Save options', 'pvn-google-map') ?>
                            </button>
                        </p>
                    </form>
                </div>
