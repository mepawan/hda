...
function mapmarker_help(){
	//include_once dirname(__DIR__).'/admin/admin-pvn-google-map-help.php';
}


// CALLBACK FUNCTION POUR L'AIDE DU PLUGIN
function mapmarker_settings(){
	include_once dirname(__DIR__).'/admin/admin-pvn-google-map-settings.php';
}


// CALLBACK FUNCTION POUR MANAGER LES CARTE & MARKER
function mapmarker_manage(){
	include_once dirname(__DIR__).'/admin/admin-pvn-google-map-manage.php';
}