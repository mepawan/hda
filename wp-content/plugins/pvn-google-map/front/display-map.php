    ...
    if(shortcode_exists($mapmarker_info[ 'shortcode' ])){
        ...
        <script type="text/javascript" async defer>
            ...
            function initMap() {
				...
				console.log('start get_markers');
                get_Markers();
				console.log('end get_markers');
            } // End initMap()
            ...
            function get_Markers() {
                ...
                for (var i = 0; i < marker_array.length; i++) {
					...
					icon = '//cdn-ds.com/public/responsive/images/map/baloon-blue.png';
					...
					console.log('start set markers');
                    set_Markers(id, latlng, icon);
					console.log('end set markers');
                }
            } // End "get_Markers()"
