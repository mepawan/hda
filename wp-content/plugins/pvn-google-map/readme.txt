...
Donate link: https://www.paypal.me/pawan1085
...
= Premium Version =
* Geocoding, create your markers with simple addresses
...
== Installation ==
1. Upload the entire `pvn-google-map` folder(unzip) to the `/wp-content/plugins/` directory or use dashboard (Plugins > Add new) and search `pvn-google-map`.
2. Activate the plugin through the `/Plugins`/ menu in WordPress.
3. Add the shortcode [pvn-google-map id=xxx] where you want display the map.


== Translations ==
* English - Austoni Mickael & Fuchs Robin
* French - Austoni Mickael
* Bulgarian (beta) - Ettaniel
* Italian (beta)- chitarrista85
